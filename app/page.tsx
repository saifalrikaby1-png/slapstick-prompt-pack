...
function CreativeDirectionSelectCard({
  ...
  return <article className="creative-direction-card creative-summary-card production-card-surface">
    <header className="creative-direction-card-header creative-summary-card-header production-card-header"><span className="creative-direction-card-icon creative-summary-card-icon production-card-icon" aria-hidden="true">{icon}</span><div><h3>{title}</h3><p>{description}</p></div></header>
      ...
      <div className={`workspace production-workspace studio-layout ${activeWorkflowTab === "outputs" ? "is-output-studio" : ""}`}>
        ...
        <section className="setup-panel production-card production-selection-panel studio-step-workspace">
          ...
          <section className="production-section form-section scene-setup-shell" id="production-setup" role="tabpanel" aria-labelledby="workflow-tab-setup" hidden={activeWorkflowTab !== "setup"}>
            ...
            {productionTab === "core" && <header className="production-section-header creative-direction-header"><span className="production-section-number" aria-hidden="true">03</span><div className="production-section-heading-copy"><h2>Creative Direction</h2><p>Guide the overall look, feel, camera language, and performance of your video. The AI will determine the location, supporting objects, action progression, and ending from your concept and selections.</p></div></header>}
            {productionTab === "motion" && <header className="production-section-header"><span className="production-section-number" aria-hidden="true">04</span><div className="production-section-heading-copy"><h2>Motion &amp; Camera</h2><p>Configure production delivery, model behavior, duration, motion level, visual style, and retention settings.</p></div></header>}
            {productionTab === "audio" && <header className="production-section-header"><span className="production-section-number" aria-hidden="true">05</span><div className="production-section-heading-copy"><h2>Audio</h2><p>Configure narration, voices, music, character sounds, and synchronized sound effects.</p></div></header>}
            {productionTab === "advanced" && <header className="production-section-header"><span className="production-section-number" aria-hidden="true">06</span><div className="production-section-heading-copy"><h2>Review &amp; Generate</h2><p>Review advanced production settings before generating the selected output package.</p></div></header>}
            {productionTab === "core" && <div className="scene-editor__body">
              <section className="production-section-content creative-direction-section" aria-labelledby="creative-direction-section-title"><h2 className="sr-only" id="creative-direction-section-title">Creative Direction controls</h2><div className="creative-direction-content"><div className="creative-direction-summary-grid">
