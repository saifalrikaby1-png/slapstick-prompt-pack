...
${body.action.includes("Action") ? "Use only the supplied cast, roles, location, object, duration, motion level, and Creative Direction. Define one clear cause-and-effect chain: setup, owner, trigger, direction, consequence, reactions, safety, and resolved state. Do not introduce characters or objects outside the supplied inventory." : ""}
