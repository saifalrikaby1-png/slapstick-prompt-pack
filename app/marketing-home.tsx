...
export function MarketingHome() {
  return <main className="marketing-shell">
    ...
    <section className="final-cta"><h2>Choose the Style. Build the Character. Plan the Production.</h2><p>Create complete AI-video production packs for slapstick, cinematic, anime, live action, fantasy, family animation, and stylized 3D—all from one connected platform.</p><div><a href="#video-types" className="marketing-button">Choose a Video Type</a><Link href="/characters" className="marketing-button secondary">Build Your First Character</Link></div></section>
