...
export default function PromptLibrary() {
  ...
  useEffect(() => setProjects(safePacks()), []);
  ...
  function open(project: StoredPack) { localStorage.setItem("slapstick-library-open-project", JSON.stringify(project)); window.location.href = "/"; }
